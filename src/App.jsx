...
const HeroSection = lazyWithRetry(
...
const ServicesSection = lazyWithRetry(
	() => import("./components/ServicesSection"),
	"ServicesSection",
);
const PriceListSection = lazyWithRetry(
	() => import("./components/PriceListSection"),
	"PriceListSection",
);
const WhyChooseUs = lazyWithRetry(
	() => import("./components/WhyChooseUs"),
	"WhyChooseUs",
);
const StatsSection = lazyWithRetry(
...
const PortfolioSection = lazyWithRetry(
...
const LehengaRentalsSection = lazyWithRetry(
	() => import("./components/LehengaRentalsSection"),
	"LehengaRentalsSection",
);
const MeetArtistSection = lazyWithRetry(
	() => import("./components/MeetArtistSection"),
	"MeetArtistSection",
);
const ProductsSection = lazyWithRetry(
	() => import("./components/ProductsSection"),
	"ProductsSection",
);
const AwardsSection = lazyWithRetry(
	() => import("./components/AwardsSection"),
	"AwardsSection",
);
const TestimonialsSection = lazyWithRetry(
	() => import("./components/TestimonialsSection"),
	"TestimonialsSection",
);
const BookingCTA = lazyWithRetry(
	() => import("./components/BookingCTA"),
	"BookingCTA",
);
const InstagramSection = lazyWithRetry(
...
function SectionSkeleton({ light = false, compact = false }) {
	return (
		<section
			className={`${light ? "bg-[var(--cream)]" : "bg-[var(--bg-main)]"} ${compact ? "py-14" : "py-20"}`}
		>
...
function SectionSlot({ children, light = false, compact = false }) {
	return (
		<Suspense fallback={<SectionSkeleton light={light} compact={compact} />}>
			{children}
		</Suspense>
	);
}
