import image3 from "./assets/images/beauty-products-display.jpg";
import image14 from "./assets/images/bow-nail-art.jpg";
import image8 from "./assets/images/braided-hairstyle.jpg";
import image11 from "./assets/images/bridal-portrait-classic-nath.jpg";
import image1 from "./assets/images/bridal-portrait-green-jewelry.jpg";
import image9 from "./assets/images/bridal-portrait-nath.jpg";
import image13 from "./assets/images/bridal-portrait-pink-emeralds.jpg";
import image10 from "./assets/images/bridal-portrait-pink-passa.jpg";
import image6 from "./assets/images/bridal-portrait-red-floral-bun.jpg";
import image17 from "./assets/images/floral-nail-art.jpg";
import image16 from "./assets/images/hydrafacial-treatment.jpg";
import image7 from "./assets/images/luxury-salon-interior.jpg";
import image12 from "./assets/images/mehendi-bangles-detail.jpg";
import image2 from "./assets/images/natural-glowing-skin.jpg";
import image15 from "./assets/images/skincare-face-wash.jpg";
import image4 from "./assets/images/bridal-portrait-1.jpg";
import image5 from "./assets/images/makeup-station.jpg";
import image18 from "./assets/images/mehendi-hands-new.jpg";
import image19 from "./assets/images/engagement-look-new.jpg";
import image20 from "./assets/images/bridal-hair-new.jpg";
import image21 from "./assets/images/salon-interior-new.jpg";
import image22 from "./assets/images/hero-background-new.jpg";
import newHeroDark from "./assets/images/new_hero_bride_dark.jpg";
import cutePinkHero from "./assets/images/cute_pink_hero.jpg";
import actualInteriorPink from "./assets/images/actual-interior-pink.webp";
import actualInteriorChairs from "./assets/images/actual-interior-chairs.webp";
import actualStorefront from "./assets/images/actual-storefront.webp";
import actualLogo from "./assets/images/actual-logo.webp";
...
export const whyChoosePoints = [
	{
		...
		description:
			"Every service includes skin analysis, look planning, and touch-up guidance for all-day confidence.",
		image: image9,
	},
	{
		title: "Certified Makeup Artist",
		description:
			"Professional training across bridal, editorial glam, and HD makeup techniques.",
		image: image7,
	},
	{
		title: "Premium Products Only",
		description:
			"High-performance products curated for Indian skin tones and long event durations.",
		image: image3,
	},
	{
		title: "Personalized Consultation",
		description:
			"Looks are tailored to your face shape, outfit palette, and event lighting.",
		image: image10,
	},
	{
		title: "Hygienic & Safe Setup",
		description:
			"Sanitized tools, fresh disposables, and skin-safe prep routine in every appointment.",
		image: image13,
	},
	{
		title: "On-Time Service",
		description:
			"Disciplined timeline management so your event schedule stays stress-free.",
		image: image11,
	},
];
...
export const services = [
	...
	},
	{
		...
		description:
			"Photo-ready complexion with lightweight, seamless finish ideal for high-resolution cameras.",
		details:
			"Balanced coverage and skin-like texture with humidity-safe setting techniques.",
	...
	},
	{
		...
		description:
			"Bold yet balanced glam looks tailored to your outfit, venue lighting, and event vibe.",
		details:
			"Custom eye options, contour styles, and transfer-resistant lip layering for long wear.",
	...
	},
	{
		...
		description:
			"Elegant glam balance with radiant skin, statement eyes, and timeless finish for portraits.",
		details:
			"Includes look consultation, accessories sync, and event-time touch-up recommendations.",
	...
	},
	{
		...
		description:
			"Structured buns, soft curls, floral pinning, and long-lasting hold for all event formats.",
		details:
			"Hairstyles are selected by face shape, weather conditions, and outfit neckline.",
	...
	},
	{
		...
		description:
			"Detailed nail styling from elegant nudes to embellished festive sets.",
		details:
			"Long-stay finish with shape consultation and outfit-matching color stories.",
	...
	},
	{
		...
		description:
			"Detailed bridal and contemporary mehendi compositions with clean line precision.",
		details:
			"Includes custom motifs, palm-to-arm patterns, and stain-care guidance.",
	...
	},
	{
		...
		description:
			"Crisp pleats, secure pinning, and silhouette-friendly draping for effortless confidence.",
	...
	},
	{
		...
		description:
			"Glow-focused facial rituals and hydration layering to improve makeup payoff.",
		details:
			"Includes skin consultation and product recommendations for pre-bridal care timeline.",
	...
	},
	{
		...
		description:
			"Experience a curated luxury studio environment for calm, camera-ready preparation.",
		details:
			"Includes personalized setup walkthrough, treatment flow planning, and event-day logistics.",
...
export const portfolio = [
	{
		...
		category: "Bridal",
		description:
			"Velvet skin and regal eye styling for timeless wedding portraits.",
	...
	},
	{
		...
		category: "Glam",
		description:
			"Flawless texture and premium jewelry framing for close camera work.",
		tags: ["Glam", "HD Finish"],
		image: image2,
		before: image3,
		after: image2,
	...
	},
	{
		...
		category: "Nail Art",
		description:
			"Close craftsmanship details with premium finish and elegant color story.",
	...
	},
	{
		...
		category: "Mehendi",
		description:
			"Intricate bridal mehendi patterns with sharp detailing and deep stain finish.",
	...
	},
	{
		...
		category: "Salon",
		description:
			"Premium studio environment designed for calm and camera-ready transformations.",
	...
	},
	{
		...
		category: "Bridal",
		description:
			"Jewelry close-up framing and polished skin details for premium bridal stories.",
	...
	},
	{
		...
		category: "Party",
		description:
			"Modern glam styling tuned for indoor and low-light event captures.",
	...
	},
	{
		...
		category: "Glam",
		description:
			"Soft-light glam finish with skin-first blending for close camera work.",
		tags: ["Glam", "HD Finish"],
		image: image2,
		before: image3,
		after: image2,
	...
	},
	{
		...
		category: "Bridal",
		description:
			"Classic bridal styling with modern balance and premium complexion finish.",
		tags: ["Bridal", "Classic"],
		image: image1,
		before: image10,
		after: image1,
...
export const googleReviews = [
	{
		...
		source: "Google",
		comment:
			"Extremely professional and punctual. The look lasted through all functions beautifully.",
	},
	{
		name: "Kritika Shah",
		rating: 5,
		source: "Google",
		comment:
			"The consultation process was detailed and reassuring. Highly recommended for brides.",
	},
	{
		name: "Anita Dsouza",
		rating: 5,
		source: "Google",
		comment:
			"Clean setup, quality products, and truly premium finishing. Worth every rupee.",
	},
];
...
export const artistProfile = {
	...
	image: image16,
	gallery: [image21, image4, image5],
	quote:
		"Beauty is not about hiding features, it is about revealing confidence with intention.",
	story:
	...
	certifications: [
		...
		"HD Makeup Pro Certification",
		"Skin Prep & Hygiene Training",
	],
};

export const instagramPosts = [
	{ image: image4, likes: "2.8K", comments: "176" },
	{ image: image19, likes: "2.1K", comments: "138" },
	{ image: image5, likes: "2.5K", comments: "149" },
	{ image: image20, likes: "2.2K", comments: "120" },
	{ image: image18, likes: "1.9K", comments: "96" },
	{ image: image21, likes: "1.7K", comments: "88" },
];

export const contactVisuals = {
	interior: actualInteriorChairs,
	ambience: actualStorefront,
	accent: image13,
};
...
export const priceList = [
	...
	},
	{
		...
		items: [
			{ name: "Mix Fruit", price: "500/-", cleanUp: "300/-" },
			{ name: "Diamond & Pearl", price: "600/-", cleanUp: "350/-" },
			{ name: "Kiwi Fruit", price: "1000/-", cleanUp: "800/-" },
			{ name: "Lightening & Brightening", price: "1000/-" },
			{ name: "Pure Whitening Vitamin", price: "2100/-" },
			{ name: "Lotus", price: "1200/-" },
			{ name: "Rich Feel Gold & Pearl", price: "1050/-" },
			{ name: "Cotton Candy For Skin Repair", price: "1800/-" },
			{ name: "O3+ Professional For Whitening", price: "2500/-" },
			{ name: "Hydra Facial", price: "4000/-" },
			{ name: "Skin Tightening", price: "2000/-" },
		],
	},
	{
		category: "Bleach",
		items: [
			...
			{ name: "Oxy", price: "250/-" },
			{ name: "Gold", price: "300/-" },
			{ name: "Richfeel Gold", price: "350/-" },
			{ name: "Vitamin-C Wine Bleach", price: "400/-" },
			{ name: "O3+ Professional", price: "500/-" },
			{ name: "Shiner Bleach", price: "500/-" },
			{ name: "Hand Bleach", price: "350/-" },
			{ name: "Legs Bleach", price: "700/-" },
	...
	},
	{
		category: "Honey Wax",
		items: [
			{ name: "Full Hand Honey Wax", price: "250/-" },
			{ name: "Underarms Honey Wax", price: "70/-" },
			{ name: "Full Leg Honey Wax", price: "400/-" },
			{ name: "Half Leg Honey Wax", price: "250/-" },
	...
	},
	{
		category: "Rica Wax",
		items: [
			{ name: "Full Hand Rica", price: "350/-" },
			{ name: "Underarms Rica", price: "150/-" },
			{ name: "Full Leg Rica", price: "750/-" },
			{ name: "Half Leg Rica", price: "500/-" },
		],
	},
	{
		category: "Roll On Wax",
		items: [
			{ name: "Full Hand Wax", price: "400/-" },
			{ name: "Underarms Wax", price: "150/-" },
			{ name: "Full Leg Wax", price: "800/-" },
			{ name: "Half Leg Wax", price: "450/-" },
		],
	},
	{
		...
		items: [
			...
			{ name: "Adv. Manicure", price: "600/-" },
			{ name: "Adv. Pedicure", price: "1000/-" },
			{ name: "Spa Manicure", price: "1200/-" },
	...
	},
	{
		...
		items: [
			...
			{ name: "Body Scrub", price: "1000/-" },
			{ name: "Cream Massage Oil Massage", price: "1500/-" },
			{ name: "Body Spa With Potli Massage", price: "2500/-" },
			{ name: "Body Polishing With Shirodhara", price: "3000/-" },
		],
	},
	{
		category: "Hair Color",
		items: [
			{ name: "Root Touchup", price: "1000/- onwards" },
			{ name: "Global Colour", price: "2500/- onwards" },
			{ name: "Highlights", price: "3500/- onwards" },
			{ name: "Crown Highlights", price: "1500/-" },
			{ name: "Global With Highlights", price: "5000/-" },
			{ name: "Amber", price: "3500/-" },
			{ name: "Balayage", price: "4000/-" },
			{ name: "Fashion Colour", price: "3500/-" },
		],
	},
	{
		category: "Hair Spa",
		items: [
			{ name: "Loreal Spa", price: "800/-" },
			{ name: "Keratin Spa", price: "1000/-" },
			{ name: "Adv. Hair Spa", price: "1200/-" },
			{ name: "Dandruff Treatment", price: "1500/-" },
			{ name: "Hair Fall Treatment", price: "1500/-" },
			{ name: "Damage Repair", price: "1800/-" },
	...
	},
	{
		category: "Hair Cuts",
		items: [
			{ name: "Straight / U / V", price: "150/-" },
			{ name: "Fringes", price: "100/-" },
			{ name: "Deep U Cut", price: "250/-" },
			{ name: "Layer Cut", price: "450/-" },
			{ name: "Feather Cut", price: "450/-" },
			{ name: "Step Cut", price: "400/-" },
			{ name: "Butter Fly Cut", price: "500/-" },
			{ name: "Baby Cut", price: "250/-" },
			{ name: "Airline Cut", price: "800/-" },
		],
	},
	{
		category: "Hair Wash",
		items: [
			...
			{ name: "Loreal Hair Wash", price: "350/-" },
			{ name: "Deep Conditioning", price: "400/-" },
			{ name: "Keratin Hair Wash", price: "450/-" },
			{ name: "Blow Dry", price: "350/-" },
			{ name: "Ironing", price: "500/- onwards" },
		],
	},
	{
		category: "Hair Treatment",
		items: [
			{ name: "Hair Smoothening", price: "4500/- onwards" },
			{ name: "Keratin", price: "3000/- onwards" },
			{ name: "Botox", price: "4000/- onwards" },
			{ name: "Nanoplastia", price: "5000/- onwards" },
			{ name: "BTR", price: "6000/- onwards" },
			{ name: "Olaplex Treatment", price: "7000/- onwards" },
		],
	},
];
