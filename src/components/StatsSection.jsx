...
function StatsSection() {
	...
	return (
		<section
			ref={ref}
			className="relative overflow-hidden bg-gradient-to-r from-black via-[#1a1412] to-black py-24 md:py-32"
		>
				...
				<div className="mt-10 grid gap-5 md:grid-cols-4">
					{stats.map((stat, index) => (
						<motion.div
							...
							className="relative rounded-3xl border border-rose-300/10 bg-white/38 p-6 text-center"
						>
