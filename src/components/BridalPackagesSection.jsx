						...
						<motion.article
							...
							className={`premium-card relative overflow-hidden rounded-3xl border p-7 ${
								pkg.recommended
									...
									: "border-rose-300/10 bg-[var(--bg-secondary)]/40"
							}`}
						>
							...
							<div className="relative z-10">
								<p className="mb-2 text-[10px] uppercase tracking-[0.22em] text-[var(--soft-pink)]">
									{pkg.style}
								</p>
								{pkg.recommended && (
								...
								<h3 className="pr-20 text-2xl text-[var(--cream)]">
									{pkg.name}
								</h3>
								<p className="mt-2 text-sm text-[var(--text-muted)]">
									Tailored for premium occasion depth and camera fidelity.
								</p>
								...
								<div className="mt-5 space-y-2 text-sm text-[var(--cream)]/85">
									...
									<p>
										<span className="text-[var(--text-muted)]">Trial:</span>{" "}
										{pkg.trial}
									</p>
									<p>
								...
								<ul className="mt-5 space-y-2">
									{pkg.includes.map((feature) => (
										<li
											key={feature}
											className="flex items-start gap-2 text-sm text-[var(--cream)]/90"
										>
											<Check className="mt-0.5 text-[var(--gold)]" size={14} />{" "}
											{feature}
										</li>
									))}
								</ul>
								...
								<div className="mt-6 flex items-end justify-between">
									...
									<MagneticButton
										...
										rel="noreferrer"
										data-cursor="Book"
										className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-[var(--text-light)]"
									>
