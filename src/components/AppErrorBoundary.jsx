  ...
  render() {
    ...
    return (
      <main className="grid min-h-screen place-items-center bg-[var(--bg-main)] px-6 text-center text-[var(--text-light)]">
        <div className="max-w-xl rounded-2xl border border-white/15 bg-white/5 p-8 backdrop-blur-md">
          <h1 className="mb-3 text-3xl font-semibold text-[var(--cream)]">We are refreshing your experience</h1>
          ...
          <button
            ...
            className="rounded-full bg-gradient-to-r from-[var(--gold)] to-[var(--rose-gold)] px-5 py-2.5 text-sm font-semibold text-black"
          >
            Refresh Website
          </button>
        </div>
