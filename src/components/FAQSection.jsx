      ...
      <div className="section-shell max-w-4xl">
        ...
        <div className="relative mx-auto mt-6 max-w-xl">
          ...
          <input
            ...
            className="w-full rounded-full border border-white/20 bg-black/35 py-3 pl-10 pr-4 text-sm text-white placeholder:text-zinc-500"
          />
        </div>
        ...
        <div className="mt-10 space-y-4">
          ...
          {filteredFaqs.length === 0 && (
            <p className="rounded-2xl border border-white/15 bg-black/35 p-5 text-center text-sm text-[var(--text-muted)]">
              No results found. Try searching with words like bridal, trial, home service, or products.
            </p>
          )}
        </div>
      </div>
