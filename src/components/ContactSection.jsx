  ...
  return (
    <section id="contact" className="bg-[var(--bg-main)] py-20 md:py-28">
      <div className="section-shell grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        >
          <p className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[var(--soft-pink)]">
            <Sparkles size={14} /> Contact Us
          </p>
          <h2 className="mt-3 text-4xl text-[var(--cream)]">Book Your Consultation</h2>
